...
class ModifyPlanningSceneSkill {
 public:
  ...
  void addObject(moveit_msgs::msg::CollisionObject& object,
                 bool invert = false);

  void attachObject(const std::string& group,
 ...
 protected:
  ...
  void allowCollisions(planning_scene::PlanningScenePtr& scene,
